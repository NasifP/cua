...
STRINGS: dict[str, tuple[str, str]] = {
    ...
    "page.memory.sub": ("What the app remembers: your notes, conversations, lab runs and how "
                        ...
                        "اللي البرنامج فاكره: ملاحظاتك، المحادثات، تجارب المعمل، ونتيجة "
                        "اختياراته. كله على جهازك بس."),
    "mem.notes": ("My notes", "ملاحظاتي"),
    "mem.talk": ("Conversations", "المحادثات"),
    "mem.lab": ("Lab journal", "سجل المعمل"),
    "mem.picks": ("Pick review", "مراجعة الاختيارات"),
    "mem.kind.preference": ("Preference", "تفضيل"),
    "mem.kind.thesis": ("Why I hold it", "سبب الشراء"),
    "mem.kind.note": ("Note", "ملاحظة"),
    "mem.symbol": ("Ticker, e.g. COMI", "الرمز، مثلاً COMI"),
    "mem.text_placeholder": ("Write it the way you would tell a friend. The chat reads it as "
                             "your words.",
                             "اكتبها زي ما تحكيها لصاحبك. الشات بيقراها على إنها كلامك."),
    "mem.thesis_template": ("Why I bought it: \nWhat could go wrong: \nI exit if: ",
                            "اشتريته ليه: \nإيه اللي ممكن يبوظ: \nهخرج لو: "),
    "mem.save": ("Save", "حفظ"),
    "mem.new": ("New", "جديد"),
    "mem.delete": ("Delete", "مسح"),
    "mem.notes_hint": ("Preferences, why you hold a stock and when you would exit. The chat "
                       "uses them to answer you; they never let the bot place an order. You "
                       "can also say \"remember that ...\" in the chat.",
                       "تفضيلاتك، وليه ماسك سهم وامتى تخرج منه. الشات بيستخدمها في ردوده، "
                       "وعمرها ما تخلي البوت يبعت أمر. تقدر كمان تكتب في الشات «افتكر إن ...»."),
    "mem.col_kind": ("Kind", "النوع"),
    "mem.col_symbol": ("Stock", "السهم"),
    "mem.col_text": ("Note", "الملاحظة"),
    "mem.col_date": ("Date", "التاريخ"),
    "mem.col_test": ("Test", "التجربة"),
    "mem.col_verdict": ("Verdict", "النتيجة"),
    "mem.col_evidence": ("Evidence", "الأرقام"),
    "mem.col_source": ("From", "المصدر"),
    "mem.col_price": ("Price", "السعر"),
    "mem.col_after": ("After {n}", "بعد {n}"),
    "mem.source.scan": ("Scan", "البحث"),
    "mem.source.plan": ("Bot plan", "خطة البوت"),
    "mem.sell": ("sell", "بيع"),
    "mem.clear_talk": ("Forget conversations", "انسى المحادثات"),
    "mem.no_talk": ("No conversations kept yet.", "لسه مافيش محادثات محفوظة."),
    "mem.review_hint": ("Each pick is measured 5, 20 and 60 sessions later against its price "
                        "at the time: up is right for a buy, down for a sell. \"-\" means not "
                        "reached yet.",
                        "كل اختيار بيتقاس بعد 5 و20 و60 جلسة مقارنةً بسعره وقتها: الطلوع صح "
                        "للشراء، والنزول صح للبيع. «-» يعني لسه ماوصلش."),
    "mem.update_prices": ("Update prices", "حدّث الأسعار"),
    "mem.fetching": ("Fetching prices for the picks ...", "بجيب أسعار الاختيارات ..."),
    "mem.updated": ("Prices updated.", "الأسعار اتحدثت."),
    "mem.archived": ("Yahoo is unreachable: showing prices from the archive.",
                     "Yahoo مش متاح: بعرض الأسعار من الأرشيف."),
    "mem.no_picks": ("No picks yet: ask the chat for the best opportunities, or let the bot "
                     "make a plan.",
                     "لسه مافيش اختيارات: اسأل الشات عن أفضل الفرص، أو سيب البوت يعمل خطة."),
    "mem.need_symbol": ("\"Why I hold it\" needs a ticker.", "«سبب الشراء» محتاج رمز السهم."),
    "mem.saved": ("Saved.", "اتحفظ."),
